...
public class OpenApiConfig {
    ...
    public GroupedOpenApi postOpenApi() {
        String packagesToscan[] = { "com.mansour.resttemplate.post" };
        return GroupedOpenApi.builder().group("Post").packagesToScan(packagesToscan)
                .build();
    }

    @Bean
    public GroupedOpenApi commentOpenApi() {
        String packagesToscan[] = { "com.mansour.resttemplate.comment" };
        return GroupedOpenApi.builder().group("Comment").packagesToScan(packagesToscan)
                .build();
    }
}
